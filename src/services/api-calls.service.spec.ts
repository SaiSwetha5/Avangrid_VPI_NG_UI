...
const vpiDataMock: VPIDataItem[] = [
  makeVPIDataItem(),
  makeVPIDataItem({ objectId: "different-id-123" }),
];
...
const mockResponse: SearchFilteredDataOutput = {
  ...
  status: 200,
  data: vpiDataMock,
  pagination: { totalRecords: vpiDataMock.length, totalPages: 1, pageNumber: 1, pageSize: 20 },
};
...
describe('ApiCallsService', () => {
  ...
  it('Should call getFilteredData Method and fetch VPI Data', () => {
